...
def require_mutable(f):
    ...
    To use this decorator, the object requires the method ``is_immutable`` to
    check for immutability::
        ...
        Traceback (most recent call last):
        ...
        AttributeError: 'A' object has no attribute 'is_immutable'

    A convenient way to achieve this is to mix in the class
    :class:`~sage.structure.Mutability`::

        sage: from sage.structure.mutability import Mutability, require_mutable, require_immutable
        sage: class A(Mutability):
        ....:  def __init__(self, val):
        ....:      self._m = val
        ....:  @require_mutable
        ....:  def change(self, new_val):
    ...
    - Michael Jung <m.jung@vu.nl>: mutability check via method
